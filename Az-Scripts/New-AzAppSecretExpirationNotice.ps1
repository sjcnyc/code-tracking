$AppID = '91152ce4-ea23-4c83-852e-05e564545fb9'
$TenantID = 'f0aff3b7-91a5-4aae-af71-c63e1dda2049'
$AppSecret = 'NGi8Q~V5dRHJ6_7WRxHjKrNhI0VFJtqTk7xn_ay-'

[int32]$expirationDays = 5
[string]$emailSender = "pwshalerts@sonymusic.com"
[string]$emailTo = "sean.connealy.ext@sonymusic.com"
...
Function Connect-MSGraphAPI {
    ...
    Process {
        Write-Output "Connecting to the Graph API"
