...
function Call-Unlocker_pff { 
    ...
    $buttonCheck_Click={ 
        ...
        $DateFormat = Get-Date -Format "yyyy/MM/dd-h:mm:ss" 
        ...
        if ($Results -ne $null){ 
            ...
            if($Results.properties.lockouttime -gt 0){ 
                ...
                Load-ListBox -ListBox $listBox1 -Items "$DateFormat - $name - Account Locked Out" -Append 
            }else{ 
                # Show the information in the ListBox 
                Load-ListBox -ListBox $listBox1 -Items "$DateFormat - $name - Account NOT Locked Out!" -Append} 
        }else { 
            # Show the information in the ListBox 
            Load-ListBox -ListBox $listbox1 -Items "$DateFormat - $name - Account Not Found!" -Append} 
    } 
    ...
    $buttonUnlock_Click={ 
        ...
        if ($Results -ne $null){ 
            ...
            # Show the information in the ListBox 
            Load-ListBox -ListBox $listBox1 -Items "$DateFormat - $name - Account Unlocked!" -Append 
        }else { 
            # Show the information in the ListBox 
            Load-ListBox -ListBox $listbox1 -Items "$DateFormat - $name - Account Not Found!" -Append} 
    }#$buttonUnlock_Click 
    ...
    $textbox1_TextChanged={ 
        ...
        if ($textbox1.Text -eq "") { 
            ...
            Load-ListBox -ListBox $listbox1 -Items "Please Enter an Account" -Append 
        } 
        if ($textbox1.Text -ne "") { 
