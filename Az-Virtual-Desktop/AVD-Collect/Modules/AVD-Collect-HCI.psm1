<#
.SYNOPSIS
   Scenario module for collecting AVD on Azure Stack HCI data
...
function CollectUEX_AVDHCILog {
    ...
    UEXAVD_LogMessage $LogLevel.Info ("Collecting Azure Stack HCI information")

    If (!($ver -like "*Windows 7*") -and !($ver -like "*Windows Server 2016*") -and !($ver -like "*Windows Server 2012*")) {
        $Commands = @(
            "UEXAVD_GetAVDLogFiles '%ProgramData%\AzureConnectedMachineAgent\Log\himds.log' himds"
            "UEXAVD_GetAVDLogFiles '%ProgramData%\AzureConnectedMachineAgent\Log\azcmagent.log' azcmagent"
        )
        UEXAVD_RunCommands $LogPrefix $Commands -ThrowException:$False -ShowMessage:$True -ShowError:$True
    } else {
        UEXAVD_LogMessage $LogLevel.Warning ("[$LogPrefix] OS not supported for Azure Stack HCI. Skipping data collection.")
    }
}

Export-ModuleMember -Function CollectUEX_AVDHCILog
# SIG # Begin signature block
# MIIntwYJKoZIhvcNAQcCoIInqDCCJ6QCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCkqjIqov+Hke7h
# Xk4uotrY6Lt8dGGFkico7jlBxRQm4KCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrmqwXjS/
# SYMTsSnF9HfEBFcCM9zMF31HVX5lzHUSiOowQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAk+A53Q7mlPBLJuoOilmVaPZsvybieZLBIsambs5KN
# lRaMWKwhLoWaYBKfx+lfgrF90E6U+dXAyyf9iCwPi8qDO1FMaSuFLLkFSs29Gvvg
# kkpF2vIt0Y+XoMw3OucPHcE7FPFwkK9INF8gQ/iD6lf3xo5bWcuu9N0oCIyHWGPO
# yfoHKcgQNRW2oDCFHtCmwriRj00QY2vdSabWHGRwkLWuNoh70q81ynE46/Dzgztr
# 2ji5Wuja9Hx8aFawPUUs6o8OVb743rxyrbN6l2J3xItLtL4qXBrFWp6eEBWKrXeG
# WtvlzDm2RA5e9gIK/6JNiSNRX0oSxg/1rZkS9C6vLDcXoYIXFjCCFxIGCisGAQQB
# gjcDAwExghcCMIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIACJyYh+2RMVT2iFkZtFBQgJi4eZDGzDaSv93hat
# vbcgAgZics8gdzMYEzIwMjIwNTE5MDUzODQ0LjAwOFowBIACAfSggdikgdUwgdIx
...
# BgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIKQ2lCNB
# AqyMseDU06obHmRDLVnh7QODFDQO1Ek5hK3hMIH6BgsqhkiG9w0BCRACLzGB6jCB
...
# 9w0BAQsFAASCAgBUei0IoRRZp2zHmmY/sLTmHv3ffqcvNsj665zPFoS3ofJbLqfp
# 2Tcch0PedK2eFGVZo+3wE4Iw+ZxLbpQagWWdYf1yE/UqwcVvR+Pi6nlfZHbxtT7+
# vQU1WEc/On3d0YsuM8u28gjGuPM0n/SVfQsleoXATdWnmL7JZB0STXxLGW/XSUoj
# eMUtUFgiTuvWaSaK9jBw8vYQgWgGF/A6L9N+zhl50ekZXtwKdqmoEdEgi9rgxpnu
# d6kdaAAMVQaBaqNJu4vzCi8epKYi3EYOGtjMUZr6xj8QXAWPeb5BzOKqhBN+X0IW
# 4Tiazglg0NYO+Gtgm2I+IgEJJrOJejNqRt5xadO9usPA5KifEpY2b/mHtm/OYl7V
# 0R5ijEoZE4pVdOzgG57iVi8icdLqTco78QQ2YyJvTTjPuqMBrt1BCqMem5CUrX+J
# mDWHezNPK+llTE6bzTFi+4rQCiWPsb7xSJpqxaMOjfLCLvsO8KsHp8U6N3YWazHT
# JQsf5lE3h3D8kD2jbGpO86KCg/5UxsIz+hhdLCU+5/AGMebs8blq8AZfjTH6hTdU
# stHKdFhBUvlvJ7HD08i+Gs8f6zLMPIpwelZm+UEO8CyQqkY6O+Lej0pa8SenpfYl
# vgNTMI5+DY69oZoCXYNGzHYjpveD2+UnAeT47hhzaCvDOPJBllA8h10X4A==
