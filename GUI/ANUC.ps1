...
function Call-ANUC_pff {
	...
	$formMain_Load={
	    ...
	    $XML.Options.Domains.Domain | Where-Object{$_.Name -match $cboDomain.Text} | Select-Object -ExpandProperty Path | %{$cboPath.Items.Add($_)}
	...
	$formMode_Click={
		if($formMode.Text -eq 'CSV Mode'){
			...
			Get-Variable | Where-Object{$_.Name -match 'txt'} | %{Try{$_.Value.Anchor = 'Top,Left'}catch{}}
			Get-Variable | Where-Object{$_.Name -match 'cbo'} | %{Try{$_.Value.Anchor = 'Top,Left'}catch{}}
			Get-Variable | Where-Object{$_.Name -match 'btn'} | %{Try{$_.Value.Anchor = 'Top,Left'}catch{}}
		  ...
		  $cboPath.Width = '249'
			...
			Get-Variable | Where-Object{$_.Name -match 'txt'} | %{Try{$_.Value.Anchor = 'Top,Left,Right'}catch{}}
			Get-Variable | Where-Object{$_.Name -match 'cbo'} | %{Try{$_.Value.Anchor = 'Top,Left,Right'}catch{}}
			Get-Variable | Where-Object{$_.Name -match 'btn'} | %{Try{$_.Value.Anchor = 'Top,Left,Right'}catch{}}
