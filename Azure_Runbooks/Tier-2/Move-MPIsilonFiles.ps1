...
Move-FilesOlderThan -SourcePath '\\storage.bmg.bagint.com\MPIsilon$\WORKSPACE\VIDEO\SHORTFORM\' -DestPath '\\storage.bmg.bagint.com\mpisilon$\X_DELETION\VIDEO\' -Days 120 -Verbose -SendEmail -ReportOnly