...
Get-NetSHScopeDHCP $Servername 
$DHCPArray = Get-TransformDHCPToArray "c:\temp\DumpAllscope$servername.txt" $ScopeDHCP 
$DHCPArray  
} 
 
function Get-TransformDHCPToArray {
   param
   (
     [Object]
     $filename,
