...
$users = "sconnea@sonymusic.com" # List of users to email your report to (separate by comma)
$fromemail = "reporter1@sonymusic.com"
$server = "ussmtp01.bmg.bagint.com" #enter your own SMTP server DNS name / IP address here
$list = $args[0] #This accepts the argument you add to your scheduled task for the list of servers. i.e. list.txt
$computers = @('ny1','ly2','10.12.112.191','10.12.112.190')# get-content $list #grab the names of the servers/computers to check from the list.txt file.
