...
$v2 = 'http://10.12.111.105/ilofw/ilo2_229.bin'
$v3 = 'http://10.12.111.105/ilofw/ilo3_188.bin'
$v4 = 'http://10.12.111.105/ilofw/ilo4_250.bin' 

#Get iLO Admin credentials and pass them on to a variable.
$iloCreds = Get-Credential
#Get the list of iLO Management Processors.
$servers = '162.49.83.13' #Get-Content C:\CSV\ilo_addresses_all.txt
