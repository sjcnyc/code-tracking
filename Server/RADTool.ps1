    ...
    Write-Output '
       ...
       Switch($m1Choice){
        ...
        '1' {
         	 ...
         	 $c = Get-ADUser -Identity $userName -Properties * | Select-Object Name,DisplayName,SamAccountName,Mail,Enabled,LastLogonDate,LastBadPasswordAttempt,DistinguishedName,SID,@{n='MemberOf';e={$_.MemberOf -join '; '}}
         	 Write-Output $c
        ...
        '2' {
              ...
              Get-ADUser -Filter * -Properties * | Select-Object Name,DisplayName,SamAccountName,Mail,Enabled,LastLogonDate,LastBadPasswordAttempt,DistinguishedName,SID,@{n='MemberOf';e={$_.MemberOf -join '; '}} | export-csv "$fPath\FullAD-Export.csv"
