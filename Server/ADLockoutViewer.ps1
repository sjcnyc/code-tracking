...
.RELEASENOTES There was an inadvertent testing string left in the CredSSP setup routine that caused it to fail. This has been fixed and should allow CredSSP to work correctly. I apologize for the oversight.
