...
$targetOu = 'bmg.bagint.com/USA/GBL/USR/Disabled'
...
$QADParams = @{
  ...
  SearchRoot                       = @('bmg.bagint.com/USA/GBL/USR/Employees', 'bmg.bagint.com/USA/GBL/USR/Arcade', 'bmg.bagint.com/USA/GBL/USR/Non Employee Users')
}
...
# scriptblock
$query = Get-QADUser @QADParams | Select-Object Name, LastLogonTimeStamp, SamAccountName, ParentContainer
