#   Name    :  Get-InactiveComputers.ps1
#   Author  :  Sean Connealy
#   Company :  Sony Music Entertainment
#   Created :  6/27/2013
#
#   Move computers object older than 90 days
#   From: "USA/GBL/WST/"  To: "NYCtest/TST/WST/Disabled"
...
table.bodyTable { border: 0px;}
table.emailContainer {border: 0px;}
table.emailHeader {border: 0px;}
