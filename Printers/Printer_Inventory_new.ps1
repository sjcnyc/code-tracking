...
#=========================================================================
Function HostList {$Printservers =  Get-Content C:\temp\printers.txt } #($SCRIPT_PARENT + "\Servers.txt")}
# ========================================================================
...
$intRow ++ 
$Sheet.Cells.Item($intRow,1) = "Printer inventory completed - $($printserver)"
$Sheet.Cells.Item($intRow,1).Font.Bold = $True
$Sheet.Cells.Item($intRow,1).Interior.ColorIndex = 40
$Sheet.Cells.Item($intRow,2).Interior.ColorIndex = 40

$output = ("c:\temp\$($Printserver)_service_{0:yyyyMMdd-HHmm}.xlsx" -f (Get-Date))
$Excel.SaveAs($output)