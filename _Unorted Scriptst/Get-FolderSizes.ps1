...
"@
        ...
        $HTML = $Report | Select-Object 'Folder Name', Owner, 'Created On', 'Last Updated', Size | Sort-Object $SortBy -Descending:$Descending | ConvertTo-Html -PreContent $Pre -PostContent $Post -Head $Header | Set-AlternatingRows -CSSEvenClass even -CSSOddClass odd | Out-File $ReportPath\FolderSizes.html
