...
$monitoredComps = @('EUGTLPWPKI12', 'USCULPWPKI11')
...
$events = Get-WindowsEventLogMessages -ComputerName $monitoredComps -LogName System -Id $eventArry -All -MaxEvents 30 |  Select-Object Id, LevelDisplayname, ProviderName, MachineName, Message # -Starttime (get-date).AddHours(-12)
