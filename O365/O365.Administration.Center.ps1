...
$ButtonConnectTo365_Click = {
  try
  {
    ...
    $partnerTIDs = Get-MsolPartnerContract -All | Select-Object -Property TenantID
		
    $domains = @()
    foreach ($TID in $partnerTIDs)
    {
      $domainName = Get-MsolDomain -TenantId $TID.TenantId | Where-Object -FilterScript { $_.IsDefault -eq 'True' }
    ...
    Load-ComboBox -ComboBox $PartnerComboBox -Items $domains -DisplayMember Name
...
$PartnerConnectButton_Click = {
  try
  {
    ...
    Import-PSSession -Session $PartnerSession -AllowClobber
    Connect-MsolService -Credential $global:o365creds
    #Disable Button
    $PartnerConnectButton.Enabled = $false
    #Sets custom button text
...
$ButtonExportToFile_Click = {
  $SavedFile = Read-Host -Prompt 'Enter the Path for file (Eg. C:\DG.csv, C:\Users.txt, C:\output\info.doc)'
  try
  {
...
$ButtonRunCustomCommand_Click = {
  ...
  try
  {
    ...
    $TextboxResults.text = Invoke-Expression -Command $userinput | Out-String
  }
  Catch
  {
    $TextboxResults.Text = ''
...
$createOutOfOfficeAutoReplyForAUserToolStripMenuItem_Click = {
  $OOOautoreplyUser = Read-Host -Prompt 'What user is the Out Of Office auto reply for?'
  $OOOInternal = Read-Host -Prompt 'What is the Internal Message'
  $OOOExternal = Read-Host -Prompt 'What is the External Message'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailboxAutoReplyConfiguration -Identity $OOOautoreplyUser |
    Format-List |
    Out-String
  }
  Catch
...
$getListOfUsersToolStripMenuItem_Click = {
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
  ...
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue )
  {
    ...
    $TextboxResults.text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -All |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, UserPrincipalName -AutoSize |
    Out-String
  }
...
$getDetailedInfoForAUserToolStripMenuItem_Click = {
  $DetailedInfoUser = Read-Host -Prompt 'Enter the UPN of the user you want more information about'
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $DetailedInfoUser |
    Format-List |
    Out-String
  }
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $DetailedInfoUser -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List |
    Out-String
  }
  Else
...
$changeUsersLoginNameToolStripMenuItem_Click = {
  $UserChangeUPN = Read-Host -Prompt 'What user would you like to change their login name for? Enter their UPN'
  $NewUserUPN = Read-Host -Prompt 'What would you like the new username to be?'
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $NewUserUPN |
    Format-List -Property UserPrincipalName |
    Out-String
  }
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $NewUserUPN -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property UserPrincipalName |
    Out-String
  }
  Else
...
$deleteAUserToolStripMenuItem_Click = {
  $DeleteUser = Read-Host -Prompt 'Enter the UPN of the user you want to delete'
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Remove-MsolUser -UserPrincipalName $DeleteUser |
    Format-List -Property UserPrincipalName |
    Out-String
  }
  ...
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Remove-MsolUser -UserPrincipalName $DeleteUser -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property UserPrincipalName |
    Out-String
  }
  Else
...
$createANewUserToolStripMenuItem_Click = {
  ...
  $DisplayName = Read-Host -Prompt 'Enter the Display Name for the new user'
  $NewUser = Read-Host -Prompt 'Enter the UPN for the new user'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = New-MsolUser -UserPrincipalName $NewUser -FirstName $Firstname -LastName $LastName -DisplayName $DisplayName |
    Format-List |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = New-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $NewUser -FirstName $Firstname -LastName $LastName -DisplayName $DisplayName |
    Format-List |
    Out-String
  }
  Else
...
$disableUserAccountToolStripMenuItem_Click = {
  $BlockUser = Read-Host -Prompt 'Enter the UPN of the user you want to disable'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $BlockUser |
    Format-List -Property DisplayName, BlockCredential |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $BlockUser -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property DisplayName, BlockCredential |
    Out-String
  }
  Else
...
$enableAccountToolStripMenuItem_Click = {
  $EnableUser = Read-Host -Prompt 'Enter the UPN of the user you want to enable'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $EnableUser |
    Format-List -Property DisplayName, BlockCredential |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $EnableUser -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property DisplayName, BlockCredential |
    Out-String
  }
  Else
...
$hideAUserFromTheGALToolStripMenuItem_Click = {
  $HidefromGALUser = Read-Host -Prompt 'Enter the UPN of the user you want to hide from the GAL'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox -Identity $HidefromGALUser |
    Format-List -Property HiddenFromAddressListsEnabled |
    Out-String
  }
  Catch
  {
...
$getUsersThatAreHiddenFromTheGALToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.HiddenFromAddressListsEnabled -eq $true } |
...
$getUsersThatAreNotHiddenFromTheGALToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.HiddenFromAddressListsEnabled -eq $false } |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$unhideAUserFromTheGALToolStripMenuItem_Click = {
  $unHidefromGALUser = Read-Host -Prompt 'Enter the UPN of the user you want to unhide from the GAL'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox -Identity $unHidefromGALUser |
    Format-List -Property HiddenFromAddressListsEnabled |
    Out-String
  }
  Catch
...
$getUserQuotaToolStripMenuItem_Click = {
  $QuotaUser = Read-Host -Prompt 'Enter the Email of the user you want to view Quota information for'
  try
  {
    ...
    $TextboxResults.text = Get-Mailbox $QuotaUser |
    Format-List -Property DisplayName, UserPrincipalName, *Quota |
    Format-List |
    Out-String
  }
  Catch
...
$getAllUsersQuotaToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.text = Get-Mailbox |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, UserPrincipalName, *Quota -AutoSize |
    Out-String
  }
  Catch
  {
...
$setUserMailboxQuotaToolStripMenuItem_Click = {
  $MailboxSetQuota = Read-Host -Prompt 'Enter the UPN of the user you want to edit quota for'
  $ProhibitSendReceiveQuota = Read-Host -Prompt 'Enter (GB) the ProhibitSendReceiveQuota value (EX: 50GB) Max:50GB'
  $ProhibitSendQuota = Read-Host -Prompt 'Enter (GB) the ProhibitSendQuota value (EX: 48GB) Max:50GB'
  $IssueWarningQuota = Read-Host -Prompt 'Enter (GB) theIssueWarningQuota value (EX: 45GB) Max:50GB'
  Try
  {
    ...
    $TextboxResults.text = Get-Mailbox $MailboxSetQuota |
    Format-List -Property DisplayName, UserPrincipalName, *Quota |
    Out-String
  }
  Catch
...
$setMailboxQuotaForAllToolStripMenuItem_Click = {
  $ProhibitSendReceiveQuota2 = Read-Host -Prompt 'Enter (GB) the ProhibitSendReceiveQuota value (EX: 50GB) Max:50GB'
  $ProhibitSendQuota2 = Read-Host -Prompt 'Enter (GB) the ProhibitSendQuota value (EX: 48GB) Max:50GB'
  $IssueWarningQuota2 = Read-Host -Prompt 'Enter (GB) theIssueWarningQuota value (EX: 45GB) Max:50GB'
  Try
  {
...
$getLicensedUsersToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Where-Object -FilterScript { $_.isLicensed -eq $true } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, Licenses -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Where-Object -FilterScript { $_.isLicensed -eq $true } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, Licenses -AutoSize |
    Out-String
...
$displayAllUsersWithoutALicenseToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Where-Object -FilterScript { $_.isLicensed -like 'False' } |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$removeAllUnlicensedUsersToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    Get-MsolUser -All |
    Where-Object -FilterScript { $_.isLicensed -ne $true } |
    Remove-MsolUser -Force
    $TextboxResults.text = Get-MsolUser -All |
    Where-Object -FilterScript { $_.isLicensed -like $true } |
    Format-List -Property UserPrincipalName |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    Get-MsolUser -all -TenantId $PartnerComboBox.SelectedItem.TenantID -All |
    Where-Object -FilterScript { $_.isLicensed -ne $true } |
    Remove-MsolUser -Force -TenantId $PartnerComboBox.SelectedItem.TenantID
    $TextboxResults.text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -All |
    Where-Object -FilterScript { $_.isLicensed -like $true } |
    Format-List -Property UserPrincipalName |
    Out-String
...
$displayAllLicenseInfoToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolAccountSku |
    Select-Object -Property AccountSkuId, ActiveUnits, WarningUnits, ConsumedUnits, @{
      Name       = 'Unused'
      Expression = {$_.ActiveUnits - $_.ConsumedUnits}
    } |
    Sort-Object -Property Unused |
    Format-Table -Property AccountSkuId, ActiveUnits, WarningUnits, ConsumedUnits, Unused -AutoSize |
    Out-String 
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolAccountSku -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Select-Object -Property AccountSkuId, ActiveUnits, WarningUnits, ConsumedUnits, @{
      Name       = 'Unused'
      Expression = {$_.ActiveUnits - $_.ConsumedUnits}
    } |
...
$addALicenseToAUserToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    $LicenseUserAdd = Read-Host -Prompt 'Enter the User Principal Name of the User you want to license'
    $LicenseUserAddLocation = Read-Host -Prompt 'Enter the 2 digit location code for the user. Example: US'
    $TextboxResults.text = Get-MsolAccountSku |
    Format-Table |
    Out-String
    $LicenseType = Read-Host -Prompt 'Enter the AccountSku of the License you want to assign to this user'
    ...
    Set-MsolUserLicense -UserPrincipalName $LicenseUserAdd -AddLicenses $LicenseType
    $TextboxResults.Text = Get-MsolUser -All -UserPrincipalName $LicenseUserAdd |
    Format-List -Property DisplayName, Licenses |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    Set-MsolUserLicense -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $LicenseUserAdd -AddLicenses $LicenseType
    $TextboxResults.Text = Get-MsolUser -All -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $LicenseUserAdd |
    Format-List -Property DisplayName, Licenses |
    Out-String
  }
  Else
...
$removeLicenseFromAUserToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    $RemoveLicenseFromUser = Read-Host -Prompt 'Enter the User Principal Name of the user you want to remove a license from'
    $TextboxResults.Text = Get-MsolUser -UserPrincipalName $RemoveLicenseFromUser |
    Format-List -Property DisplayName, Licenses |
    Out-String
    $RemoveLicenseType = Read-Host -Prompt 'Enter the AccountSku of the license you want to remove'
  ...
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    $TenantText = $PartnerComboBox.text
    $RemoveLicenseFromUser = Read-Host -Prompt 'Enter the User Principal Name of the user you want to remove a license from'
    $TextboxResults.Text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $RemoveLicenseFromUser |
    Format-List -Property DisplayName, Licenses |
    Out-String
    $RemoveLicenseType = Read-Host -Prompt 'Enter the AccountSku of the license you want to remove'
    $TextboxResults.Text = "Removing the $RemoveLicenseType license from $RemoveLicenseFromUser..."
...
$addCalendarPermissionsToolStripMenuItem_Click = {
  $Calendaruser = Read-Host -Prompt 'Enter the UPN of the user whose Calendar you want to give access to'
  $Calendaruser2 = Read-Host -Prompt 'Enter the UPN of the user who you want to give access to'
  $TextboxResults.text = 'Calendar Permissions: 
    ...
    AvailabilityOnly
  LimitedDetails'
  $level = Read-Host -Prompt 'Access Level?'
  try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${Calendaruser}:\calendar |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, Identity, FolderName, IsValid -AutoSize |
    Out-String
  }
  Catch
  {
...
$viewUsersCalendarPermissionsToolStripMenuItem_Click = {
  $CalUserPermissions = Read-Host -Prompt 'What user would you like calendar permissions for?'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${CalUserPermissions}:\calendar |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, Identity, FolderName, IsValid -AutoSize |
    Out-String
  }
...
$addsingsUsersPermissionToAllCalrndarToolStripMenuItem_Click = {
  $MasterUser = Read-Host -Prompt 'Enter the UPN of the user you want permission on all users calendars'
  $TextboxResults.text = 'Calendar Permissions: 
    Owner
    PublishingEditor
    Editor
    ...
    AvailabilityOnly
  LimitedDetails'
  $level2 = Read-Host -Prompt 'Access Level?'
  try
  {
...
$removeAUserFromAllCalendarsToolStripMenuItem_Click = {
  $RemoveUserFromAll = Read-Host -Prompt 'Enter the UPN of the user you want to remove from all calendars'
  try
  {
...
$removeAUserFromSomesonsCalendarToolStripMenuItem_Click = {
  $Calendaruserremove = Read-Host -Prompt 'Enter the UPN of the user whose calendar you want to remove access to'
  $Calendaruser2remove = Read-Host -Prompt 'Enter the UPN of the user who you want to remove access'
  try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${Calendaruserremove}:\calendar |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, Identity, FolderName, IsValid -AutoSize |
    Out-String
  }
...
$disableClutterForAllToolStripMenuItem_Click = {
  try
  {
    ...
    Format-List -Property MailboxIdentity, IsEnabled |
    Out-String
  }
  Catch
  {
...
$enableClutterForAUserToolStripMenuItem_Click = {
  $UserEnableClutter = Read-Host -Prompt 'Which user would you like to enable Clutter for?'
  try
  {
    ...
    $TextboxResults.text = Get-Mailbox $UserEnableClutter |
    Set-Clutter -Enable $true |
    Format-List |
    Out-String
  }
...
$disableClutterForAUserToolStripMenuItem_Click = {
  $UserDisableClutter = Read-Host -Prompt 'Which user would you like to disable Clutter for?'
  try
  {
    ...
    $TextboxResults.text = Get-Mailbox $UserDisableClutter |
    Set-Clutter -Enable $false |
    Format-List |
    Out-String
  }
...
$getClutterInfoForAUserToolStripMenuItem_Click = {
  $GetCluterInfoUser = Read-Host -Prompt 'What user would you like to view Clutter information about?'
  Try
  {
    ...
    $TextboxResults.Text = Get-Clutter -Identity $GetCluterInfoUser |
    Format-List -Property MailboxIdentity, IsEnabled |
    Out-String
  }
  Catch
...
$displayAllDeletedUsersToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -All -ReturnDeletedUsers |
    Sort-Object -Property UserprincipalName |
    Format-Table -Property UserPrincipalName, ObjectID -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -All -TenantId $PartnerComboBox.SelectedItem.TenantID -ReturnDeletedUsers |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName, ObjectID -AutoSize |
    Out-String
  }
...
$deleteAllUsersInRecycleBinToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -ReturnDeletedUsers |
  ...
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -ReturnDeletedUsers |
    Remove-MsolUser -RemoveFromRecycleBin -Force |
    Format-List |
    Out-String
  }
...
$deleteSpecificUsersInRecycleBinToolStripMenuItem_Click = {
  $DeletedUserRecycleBin = Read-Host -Prompt 'Please enter the User Principal Name of the user you want to permanently delete'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
...
$restoreDeletedUserToolStripMenuItem_Click = {
  $RestoredUserFromRecycleBin = Read-Host -Prompt 'Enter the User Principal Name of the user you want to restore'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
...
$getQuarantineBetweenDatesToolStripMenuItem_Click = {
  $StartDateQuarentine = Read-Host -Prompt 'Enter the beginning date. (Format MM/DD/YYYY)'
  $EndDateQuarentine = Read-Host -Prompt 'Enter the end date. (Format MM/DD/YYYY)'
  try
  {
    ...
    $TextboxResults.Text = Get-QuarantineMessage -StartReceivedDate $StartDateQuarentine -EndReceivedDate $EndDateQuarentine |
    Format-List -Property ReceivedTime, SenderAddress, RecipientAddress, Subject, Size, Type, Expires, QuarantinedUser, ReleasedUser, Direction |
    Out-String
  }
  catch
  {
...
$getQuarantineFromASpecificUserToolStripMenuItem_Click = {
  $QuarentineFromUser = Read-Host -Prompt 'Enter the email address you want to see quarentine from'
  try
  {
    ...
    $TextboxResults.Text = Get-QuarantineMessage -SenderAddress $QuarentineFromUser |
    Format-List -Property ReceivedTime, SenderAddress, RecipientAddress, Subject, Size, Type, Expires, QuarantinedUser, ReleasedUser, Direction |
    Out-String
  }
  catch
...
$getQuarantineToASpecificUserToolStripMenuItem_Click = {
  $QuarentineInfoForUser = Read-Host -Prompt 'Enter the email of the user you want to view quarantine for'
  try
  {
    ...
    $TextboxResults.Text = Get-QuarantineMessage -RecipientAddress $QuarentineInfoForUser |
    Format-List -Property ReceivedTime, SenderAddress, Subject, Size, Type, Expires, QuarantinedUser, ReleasedUser, Direction |
    Out-String
  }
  catch
  {
...
$enableStrongPasswordForAUserToolStripMenuItem_Click = {
  $UserEnableStrongPasswords = Read-Host -Prompt 'Enter the User Principal Name of the user you want to enable strong password policy for'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $UserEnableStrongPasswords |
    Format-List -Property UserPrincipalName, StrongPasswordRequired |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $UserEnableStrongPasswords -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property UserPrincipalName, StrongPasswordRequired |
    Out-String
  }
  Else
...
$getAllUsersStrongPasswordPolicyInfoToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Sort-Object -Property DisplayName |
    Format-Table  -Property DisplayName, strongpasswordrequired -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$disableStrongPasswordsForAUserToolStripMenuItem_Click = {
  $UserdisableStrongPasswords = Read-Host -Prompt 'Enter the User Principal Name of the user you want to disable strong password policy for'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $UserdisableStrongPasswords |
    Format-List -Property UserPrincipalName, StrongPasswordRequired |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $UserdisableStrongPasswords -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property UserPrincipalName, StrongPasswordRequired |
    Out-String
  }
  Else
...
$resetPasswordForAUserToolStripMenuItem1_Click = {
  $ResetPasswordUser = Read-Host -Prompt 'Enter the UPN of the user you want to reset the password for'
  $NewPassword = Read-Host -Prompt 'What would you like the new password to be?'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
...
$setPasswordToNeverExpireForAllToolStripMenuItem1_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName, PasswordNeverExpires -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$resetPasswordForAllToolStripMenuItem_Click = {
  $SetPasswordforAll = Read-Host -Prompt 'What password would you like to set for all users?'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    Get-MsolUser -All | ForEach-Object -Process { Set-MsolUserPassword -UserPrincipalName $_.UserPrincipalName -NewPassword $SetPasswordforAll -ForceChangePassword $false }
  ...
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -All | ForEach-Object -Process { Set-MsolUserPassword -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $_.UserPrincipalName -NewPassword $SetPasswordforAll -ForceChangePassword $false }
    $TextboxResults.Text = "Password for all users has been set to $SetPasswordforAll"
  }
  Else
  {
...
$setATemporaryPasswordForAllToolStripMenuItem_Click = {
  $SetTempPasswordforAll = Read-Host -Prompt 'What password would you like to set for all users?'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
...
$TemporaryPasswordForAUserToolStripMenuItem_Click = {
  $ResetPasswordUser2 = Read-Host -Prompt 'Enter the UPN of the user you want to reset the password for'
  $NewPassword2 = Read-Host -Prompt 'What would you like the new password to be?'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
...
$getPasswordResetDateForAUserToolStripMenuItem_Click = {
  $GetPasswordInfoUser = Read-Host -Prompt 'Enter the UPN of the user you want to view the password last changed date for'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -userprincipalname $GetPasswordInfoUser |
    Format-List -Property UserPrincipalName, lastpasswordchangetimestamp |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -userprincipalname $GetPasswordInfoUser |
    Format-List -Property UserPrincipalName, lastpasswordchangetimestamp |
    Out-String
  }
  Else
...
$getPasswordLastResetDateForAllToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolUser -All |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName, lastpasswordchangetimestamp -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$setPasswordToExpireForAUserToolStripMenuItem_Click = {
  $PasswordtoExpireforUser = Read-Host -Prompt 'Enter the UPN of the user you want the password to expire for'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $PasswordtoExpireforUser |
    Format-List -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $PasswordtoExpireforUser |
    Format-List -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
  Else
...
$setPasswordToNeverExpireForAUserToolStripMenuItem_Click = {
  $PasswordtoNeverExpireforUser = Read-Host -Prompt 'Enter the UPN of the user you want the password to never expire for'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -UserPrincipalName $PasswordtoNeverExpireforUser |
    Format-List -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -TenantId $PartnerComboBox.SelectedItem.TenantID -UserPrincipalName $PasswordtoNeverExpireforUser |
    Format-List -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
  Else
...
$getUsersWhosPasswordNeverExpiresToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Where-Object -FilterScript { $_.PasswordNeverExpires -eq $true } |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$getUsersWhosPasswordWillExpireToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.text = Get-MsolUser -All |
    Where-Object -FilterScript { $_.PasswordNeverExpires -eq $false } |
    Sort-Object -Property UserPrincipalName |
    Format-Table -Property UserPrincipalName, PasswordNeverExpires |
    Out-String
  }
...
$getUsersNextPasswordResetDateToolStripMenuItem_Click = {
  $NextUserResetDateUser = Read-Host -Prompt 'Enter the UPN of the user'
  $VarDate = Read-Host -Prompt 'Enter days before passwords expires. EX: 90'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = (Get-MsolUser -All -userprincipalname $NextUserResetDateUser).lastpasswordchangetimestamp.adddays($VarDate) |
    Format-List -Property DateTime |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = (Get-MsolUser -All -TenantId $PartnerComboBox.SelectedItem.TenantID -userprincipalname $NextUserResetDateUser).lastpasswordchangetimestamp.adddays($VarDate) |
    Format-List -Property DateTime |
    Out-String
  }
  Else
...
$addFullPermissionsToAMailboxToolStripMenuItem_Click = {
  $mailboxAccess = Read-Host -Prompt 'Mailbox you want to give full-access to'
  $mailboxUser = Read-Host -Prompt 'Enter the UPN of the user that will have full access'
  try
  {
    ...
    $TextboxResults.text = Add-MailboxPermission $mailboxAccess -User $mailboxUser -AccessRights FullAccess -InheritanceType All |
    Format-List |
    Out-String
  }
  Catch
...
$addSendAsPermissionToAMailboxToolStripMenuItem_Click = {
  $SendAsAccess = Read-Host -Prompt 'Mailbox you want to give Send As access to'
  $mailboxUserAccess = Read-Host -Prompt 'Enter the UPN of the user that will have Send As access'
  try
  {
    ...
    $TextboxResults.text = Add-RecipientPermission $SendAsAccess -Trustee $mailboxUserAccess -AccessRights SendAs |
    Format-List |
    Out-String
  }
  Catch
...
$assignSendOnBehalfPermissionsForAMailboxToolStripMenuItem_Click = {
  $SendonBehalfof = Read-Host -Prompt 'Mailbox you want to give Send As access to'
  $mailboxUserSendonBehalfAccess = Read-Host -Prompt 'Enter the UPN of the user that will have Send As access'
  try
  {
    ...
    $TextboxResults.text = Get-Mailbox -Identity $SendonBehalfof |
    Format-List -Property Identity, GrantSendOnBehalfTo |
    Out-String
  }
  Catch
  {
...
$displayMailboxPermissionsForAUserToolStripMenuItem_Click = {
  $MailboxUserFullAccessPermission = Read-Host -Prompt 'Enter the UPN of the user want to view Full Access permissions for'
  try
  {
    ...
    $TextboxResults.text = Get-MailboxPermission $MailboxUserFullAccessPermission |
    Where-Object -FilterScript { ($_.IsInherited -eq $false) -and -not ($_.User -like 'NT AUTHORITY\SELF') } |
...
$displaySendAsPermissionForAMailboxToolStripMenuItem_Click = {
  $MailboxUserSendAsPermission = Read-Host -Prompt 'Enter the UPN of the user you want to view Send As permissions for'
  try
  {
    ...
    $TextboxResults.text = Get-RecipientPermission $MailboxUserSendAsPermission |
    Where-Object -FilterScript { ($_.IsInherited -eq $false) -and -not ($_.Trustee -like 'NT AUTHORITY\SELF') } |
    Sort-Object -Property User |
    Format-Table -AutoSize |
    Out-String
  }
...
$displaySendOnBehalfPermissionsForMailboxToolStripMenuItem_Click = {
  $MailboxUserSendonPermission = Read-Host -Prompt 'Enter the UPN of the user you want to view Send On Behalf Of permission for'
  try
  {
    ...
    $TextboxResults.text = Get-RecipientPermission $MailboxUserSendonPermission |
    Where-Object -FilterScript { ($_.IsInherited -eq $false) -and -not ($_.Trustee -like 'NT AUTHORITY\SELF') } |
    Sort-Object -Property User |
    Format-Table |
    Out-String
...
$removeFullAccessPermissionsForAMailboxToolStripMenuItem_Click = {
  $UserRemoveFullAccessRights = Read-Host -Prompt 'What user mailbox would you like modify Full Access rights to'
  $RemoveFullAccessRightsUser = Read-Host -Prompt 'Enter the UPN of the user you want to remove'
  try
  {
    ...
    $TextboxResults.text = Get-MailboxPermission $UserRemoveFullAccessRights |
    Where-Object -FilterScript { ($_.IsInherited -eq $false) -and -not ($_.User -like 'NT AUTHORITY\SELF') } |
    Sort-Object -Property User |
    Format-Table |
    Out-String
...
$revokeSendAsPermissionsForAMailboxToolStripMenuItem_Click = {
  $UserDeleteSendAsAccessOn = Read-Host -Prompt 'What user mailbox would you like to modify Send As permission for?'
  $UserDeleteSendAsAccess = Read-Host -Prompt 'Enter the UPN of the user you want to remove Send As access to?'
  try
  {
    ...
    $TextboxResults.Text = Remove-RecipientPermission $UserDeleteSendAsAccessOn -AccessRights SendAs -Trustee $UserDeleteSendAsAccess |
    Sort-Object -Property User |
    Format-Table |
    Out-String
  }
...
$viewAllMailboxesAUserHasFullAccessToToolStripMenuItem_Click = {
  $ViewAllFullAccess = Read-Host -Prompt 'Enter the UPN of the account you want to view'
  try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Get-MailboxPermission -User $ViewAllFullAccess |
...
$viewAllMailboxesAUserHasSendAsPermissionsToToolStripMenuItem_Click = {
  $ViewSendAsAccess = Read-Host -Prompt 'Enter the UPN of the account you want to view'
  try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Get-RecipientPermission -Trustee $ViewSendAsAccess |
    Sort-Object -Property Identity |
    Format-Table |
    Out-String
  }
...
$viewAllMailboxesAUserHasSendOnBehaldPermissionsToToolStripMenuItem_Click = {
  $ViewSendonBehalf = Read-Host -Prompt 'Enter the Name of the account you want to view'
  try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.GrantSendOnBehalfTo -match $ViewSendonBehalf } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, GrantSendOnBehalfTo, PrimarySmtpAddress, RecipientType |
    Out-String
  }
  Catch
  {
...
$removeAllPermissionsToAMailboxToolStripMenuItem_Click = {
  $UserDeleteAllAccessOn = Read-Host -Prompt 'What user mailbox would you like to modify permissions for?'
  $UserDeleteAllAccess = Read-Host -Prompt 'Enter the UPN of the user you want to remove access to?'
  try
  {
...
$getAllUsersForwardinToInternalRecipientToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.ForwardingAddress -ne $Null -and $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, ForwardingAddress, DeliverToMailboxAndForward -AutoSize |
    Out-String
  }
  Catch
  {
...
$forwardToInternalRecipientAndDontSaveLocalCopyToolStripMenuItem_Click = {
  $UsertoFWD2 = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  $Fwd2me2 = Read-Host -Prompt 'Enter the Name, Display Name, Alias, or Email Address of the user to forward to'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $UsertoFWD2 |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingAddress |
    Out-String
  }
  Catch
  {
...
$forwardToExternalAddressAndSaveLocalCopyToolStripMenuItem_Click = {
  $UsertoFWD3 = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  $Fwd2me2External = Read-Host -Prompt 'Enter the external email address to forward to'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $UsertoFWD3 |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress |
    Out-String
  }
  Catch
  {
...
$forwardToExternalAddressAndDontSaveLocalCopyToolStripMenuItem_Click = {
  $UsertoFWD4 = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  $Fwd2me2External2 = Read-Host -Prompt 'Enter the external email address to forward to'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $UsertoFWD4 |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress |
    Out-String
  }
  Catch
...
$getForwardingInfoForAUserToolStripMenuItem_Click = {
  $UserFwdInfo = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $UserFwdInfo |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingAddress, ForwardingSmtpAddress |
    Out-String
  }
  Catch
  {
...
$removeExternalForwadingForAUserToolStripMenuItem_Click = {
  $RemoveFWDfromUserExternal = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $RemoveFWDfromUserExternal |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress |
    Out-String
  }
  Catch
...
$removeAllForwardingForAUserToolStripMenuItem_Click = {
  $RemoveAllFWDforUser = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $RemoveAllFWDforUser |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingAddress, ForwardingSmtpAddress |
    Out-String
  }
  Catch
...
$removeInternalForwardingForUserToolStripMenuItem_Click = {
  $RemoveFWDfromUser = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $RemoveFWDfromUser |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingAddress |
    Out-String
  }
  Catch
...
$forwardToInternalRecipientAndSaveLocalCopyToolStripMenuItem_Click = {
  $UsertoFWD = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  $Fwd2me = Read-Host -Prompt 'Enter the Name, Display Name, Alias, or Email Address of the user to forward to'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $UsertoFWD |
    Format-List -Property Name, DeliverToMailboxAndForward, ForwardingAddress |
    Out-String
  }
  Catch
...
$getAllUsersForwardingToExternalRecipientToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.ForwardingSmtpAddress -ne $Null -and $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress -AutoSize |
    Out-String
  }
  Catch
  {
...
$removeAllForwardingForAllUsersToolStripMenuItem_Click = {
  Try
  {
    ...
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-Mailbox -ForwardingAddress $Null -ForwardingSmtpAddress $Null
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingAddress, ForwardingSmtpAddress -AutoSize |
    Out-String
  }
  Catch
  {
...
$removeInternalForwardingForAllUsersToolStripMenuItem_Click = {
  Try
  {
    ...
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingAddress -AutoSize |
    Out-String
  }
  Catch
  {
...
$forwardAllUsersEmailToExternalRecipientAndSaveALocalCopyToolStripMenuItem_Click = {
  $ForwardAllToExternal = Read-Host -Prompt 'Enter the email to forward all email to'
  Try
  {
    ...
    Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-Mailbox -ForwardingsmtpAddress $ForwardAllToExternal -DeliverToMailboxAndForward $true
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress -AutoSize |
...
$forwardAllUsersEmailToExternalRecipientAndDontSaveALocalCopyToolStripMenuItem_Click = {
  $ForwardAllToExternal2 = Read-Host -Prompt 'Enter the email to forward all email to'
  Try
  {
    ...
    Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-Mailbox -ForwardingsmtpAddress $ForwardAllToExternal2 -DeliverToMailboxAndForward $false
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingSmtpAddress -AutoSize |
...
$forwardAllUsersEmailToInternalRecipientAndSaveLocalCopyToolStripMenuItem_Click = {
  $ForwardAllToInternal = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  Try
  {
    ...
    Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-Mailbox -ForwardingAddress $ForwardAllToInternal -DeliverToMailboxAndForward $true
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingAddress |
    Out-String
  }
  Catch
  {
...
$forwardAllUsersEmailToInternalRecipientAndDontSaveLocalCopyToolStripMenuItem_Click = {
  $ForwardAllToInternal2 = Read-Host -Prompt 'Enter the users UPN, Display Name, Alias, or Email Address of the user to forward'
  Try
  {
    ...
    Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-Mailbox -ForwardingAddress $ForwardAllToInternal2 -DeliverToMailboxAndForward $true
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Sort-Object -Property Name |
    Format-Table -Property Name, DeliverToMailboxAndForward, ForwardingAddress |
...
$displayDistributionGroupsToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup |
    Where-Object -FilterScript { $_.GroupType -notlike 'Universal, SecurityEnabled'} |
    Sort-Object -Property DisplayName |
...
$createADistributionGroupToolStripMenuItem_Click = {
  $NewDistroGroup = Read-Host -Prompt 'What is the name of the new Distribution Group?'
  try
  {
    ...
    $TextboxResults.Text = New-DistributionGroup -Name $NewDistroGroup |
    Format-List |
    Out-String
  }
  catch
...
$deleteADistributionGroupToolStripMenuItem_Click = {
  $DeleteDistroGroup = Read-Host -Prompt 'Enter the name of the Distribtuion group you want deleted.'
  try
  {
...
$allowDistributionGroupToReceiveExternalEmailToolStripMenuItem_Click = {
  $AllowExternalEmail = Read-Host -Prompt 'Enter the name of the Distribtuion Group you want to allow external email to'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $AllowExternalEmail |
    Format-List -Property Name, RequireSenderAuthenticationEnabled |
    Out-String
  }
  catch
  {
...
$hideDistributionGroupFromGALToolStripMenuItem_Click = {
  $GroupHideGAL = Read-Host -Prompt 'Enter the name of the Distribtuion Group you want to allow external email to'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $GroupHideGAL |
    Format-List -Property Name, HiddenFromAddressListsEnabled |
    Out-String
  }
  catch
  {
...
$displayDistributionGroupMembersToolStripMenuItem_Click = {
  $ListDistributionGroupMembers = Read-Host -Prompt 'Enter the name of the Distribution Group you want to list members of'
  try
  {
    ...
    $TextboxResults.Text = Get-DistributionGroupMember $ListDistributionGroupMembers |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$addAUserToADistributionGroupToolStripMenuItem_Click = {
  $DistroGroupAdd = Read-Host -Prompt 'Enter the name of the Distribution Group'
  $DistroGroupAddUser = Read-Host -Prompt "Enter the UPN of the user you wish to add to $DistroGroupAdd"
  try
  {
    ...
    $TextboxResults.Text = Get-DistributionGroupMember $DistroGroupAdd |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$removeAUserADistributionGroupToolStripMenuItem_Click = {
  $DistroGroupRemove = Read-Host -Prompt 'Enter the name of the Distribution Group'
  $DistroGroupRemoveUser = Read-Host -Prompt "Enter the UPN of the user you wish to remove from $DistroGroupRemove"
  try
  {
    ...
    $TextboxResults.Text = Get-DistributionGroupMember $DistroGroupRemove |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$addAllUsersToADistributionGroupToolStripMenuItem_Click = {
  $users = Get-Mailbox | Select-Object -ExpandProperty Alias
  $AddAllUsersToSingleDistro = Read-Host -Prompt 'Enter the name of the Distribution Group you want to add all users to'
  try
  {
    ...
    $TextboxResults.Text = Get-DistributionGroupMember $AddAllUsersToSingleDistro |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$getDetailedInfoForDistributionGroupToolStripMenuItem_Click = {
  $DetailedInfoMailDistroGroup = Read-Host -Prompt 'Enter the group name'
  Try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $DetailedInfoMailDistroGroup |
    Format-List |
    Out-String
  }
  Catch
...
$allowAllDistributionGroupsToReceiveExternalEmailToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup |
    Sort-Object -Property Name |
    Format-Table -Property Name, RequireSenderAuthenticationEnabled -AutoSize |
    Out-String
  }
  catch
  {
...
$denyDistributionGroupFromReceivingExternalEmailToolStripMenuItem_Click = {
  $DenyExternalEmail = Read-Host -Prompt 'Enter the name of the Distribtuion Group you want to deny external email to'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $DenyExternalEmail |
    Sort-Object -Property Name |
    Format-Table -Property Name, RequireSenderAuthenticationEnabled -AutoSize |
    Out-String
  }
...
$getExternalEmailStatusForADistributionGroupToolStripMenuItem_Click = {
  $ExternalEmailStatus = Read-Host -Prompt 'Enter the Distribution Group'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $ExternalEmailStatus |
    Format-List -Property Name, RequireSenderAuthenticationEnabled |
    Out-String
  }
  catch
...
$getListOfUnifiedGroupsToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroup |
    Sort-Object -Property Name |
    Format-Table -AutoSize |
    Out-String
  }
...
$listMembersOfAGroupToolStripMenuItem_Click = {
  $GetUnifiedGroupMembers = Read-Host -Prompt 'Enter the name of the group you want to view members for.'
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $GetUnifiedGroupMembers -LinkType Members |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName -AutoSize |
    Out-String
  }
...
$removeAGroupToolStripMenuItem_Click = {
  $RemoveUnifiedGroup = Read-Host -Prompt 'Enter the name of the group you want to remove'
  try
  {
...
$addAUserToAGroupToolStripMenuItem_Click = {
  $UnifiedGroupAddUser = Read-Host -Prompt 'Enter the name of the group you want to add a user to'
  $UnifiedGroupUserAdd = Read-Host -Prompt "Enter the UPN of the user you want to add to the $UnifiedGroupAddUser group."
  $TextboxResults.Text = 'Access Levels:
    Members
    Owners
  Subscribers'
  $UnifiedGroupAccess = Read-Host -Prompt "Enter the level of access you want $UnifiedGroupUserAdd to have."
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $UnifiedGroupAddUser -LinkType Members |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName -AutoSize |
    Out-String
  }
...
$createANewGroupToolStripMenuItem_Click = {
  $NewUnifiedGroupName = Read-Host -Prompt 'Enter the Display Name of the new group'
  $NewUnifiedGroupAccessType = Read-Host -Prompt "Enter the Access Type for the group $NewUnifiedGroupName (Public or Private)"
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroup $NewUnifiedGroupName |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$listOwnersOfAGroupToolStripMenuItem_Click = {
  $GetUnifiedGroupOwners = Read-Host -Prompt 'Enter the name of the group you want to view members for.'
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $GetUnifiedGroupOwners -LinkType Owners |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$listSubscribersOfAGroupToolStripMenuItem_Click = {
  $GetUnifiedGroupSubscribers = Read-Host -Prompt 'Enter the name of the group you want to view members for.'
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $GetUnifiedGroupSubscribers -LinkType Subscribers |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$addAnOwnerToAGroupToolStripMenuItem_Click = {
  ...
  $UnifiedGroupAddOwner = Read-Host -Prompt 'Enter the name of the group you want to modify ownership for'
  $AddUnifiedGroupOwner = Read-Host -Prompt 'Enter the UPN of the user you want to become an owner'
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $UnifiedGroupAddOwner -LinkType Owners |
    Sort-Object -Property DisplayName |
    Format-Table -AutoSize |
    Out-String
  }
...
$addASubscriberToAGroupToolStripMenuItem_Click = {
  $UnifiedGroupAddSubscriber = Read-Host -Prompt 'Enter the name of the group you want to add a subscriber for'
  $AddUnifiedGroupSubscriber = Read-Host -Prompt 'Enter the UPN of the user you want to add as a subscriber'
  try
  {
    ...
    $TextboxResults.Text = Get-UnifiedGroupLinks -Identity $UnifiedGroupAddSubscriber -LinkType Subscribers |
    Sort-Object -Property DisplayName |
    Format-List |
    Out-String
  }
...
$createARegularSecurityGroupToolStripMenuItem_Click = {
  $SecurityGroupName = Read-Host -Prompt 'Enter a name for the new Security Group'
  #What to do if connected to main o365 account
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = New-MsolGroup -DisplayName $SecurityGroupName |
    Format-List |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = New-MsolGroup -DisplayName $SecurityGroupName -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List |
    Out-String
  }
  Else
...
$getAllRegularSecurityGroupsToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolGroup -GroupType Security |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, GroupType -AutoSize |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolGroup -TenantId $PartnerComboBox.SelectedItem.TenantID -GroupType Security |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, GroupType -AutoSize |
    Out-String
  }
...
$getAllMailEnabledSecurityGroupsToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup |
    Where-Object -FilterScript { $_.GroupType -like 'Universal, SecurityEnabled' } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, SamAccountName, GroupType, IsDirSynced, EmailAddresses -AutoSize |
    Out-String
  }
  Catch
  {
...
$createAMailEnabledSecurityGroupToolStripMenuItem_Click = {
  $MailEnabledSecurityGroup = Read-Host -Prompt 'Enter the name of the security group'
  $MailEnabledSMTPAddress = Read-Host -Prompt "Enter the primary SMTP address for $MailEnabledSecurityGroup"
  Try
  {
    ...
    $TextboxResults.Text = New-DistributionGroup -Name $MailEnabledSecurityGroup -Type Security -PrimarySmtpAddress $MailEnabledSMTPAddress |
    Format-List |
    Out-String
  }
  Catch
...
$addAUserToAMailEnabledSecurityGroupToolStripMenuItem_Click = {
  $MailEnabledGroupAdd = Read-Host -Prompt 'Enter the name of the Group'
  $MailEnabledGroupAddUser = Read-Host -Prompt "Enter the UPN of the user you wish to add to $MailEnabledGroupAdd"
  try
  {
    ...
    $TextboxResults.Text = Get-DistributionGroupMember $MailEnabledGroupAdd |
    Sort-Object -Property DisplayName |
    Format-Table -Property Displayname -AutoSize |
    Out-String
  }
...
$allowSecurityGroupToRecieveExternalMailToolStripMenuItem_Click = {
  $AllowExternalEmailSecurity = Read-Host -Prompt 'Enter the name of the Group you want to allow external email to'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $AllowExternalEmailSecurity |
    Format-List -Property Name, RequireSenderAuthenticationEnabled |
    Out-String
  }
  catch
...
$getDetailedInfoForMailEnabledSecurityGroupToolStripMenuItem_Click = {
  $DetailedInfoMailEnabledSecurityGroup = Read-Host -Prompt 'Enter the group name'
  Try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $DetailedInfoMailEnabledSecurityGroup |
    Format-List |
    Out-String
  }
  Catch
...
$removeMailENabledSecurityGroupToolStripMenuItem_Click = {
  $DeleteMailEnabledSecurityGroup = Read-Host -Prompt 'Enter the name of the group you want deleted.'
  try
  {
...
$denySecurityGroupFromRecievingExternalEmailToolStripMenuItem_Click = {
  $DenyExternalEmailSecurity = Read-Host -Prompt 'Enter the name of the Group you want to deny external email to'
  try
  {
    ...
    $TextboxResults.text = Get-DistributionGroup $DenyExternalEmailSecurity |
    Format-List -Property Name, RequireSenderAuthenticationEnabled |
    Out-String
  }
  catch
...
$allowConflictMeetingsToolStripMenuItem_Click = {
  $ConflictMeetingAllow = Read-Host -Prompt 'Enter the Room Name of the Resource Calendar you want to allow conflicts'
  try
  {
    ...
    $TextboxResults.Text = Get-CalendarProcessing -identity $ConflictMeetingAllow |
    Format-List -Property Identity, AllowConflicts |
    Out-String
  }
  catch
  {
...
$denyConflictMeetingsForAllResourceMailboxesToolStripMenuItem_Click = {
  Try
  {
    ...
    Get-MailBox |
    Where-Object -FilterScript { $_.ResourceType -eq 'Room' } |
    Set-CalendarProcessing -AllowConflicts $false
    $TextboxResults.Text = Get-MailBox |
    Where-Object -FilterScript { $_.ResourceType -eq 'Room' } |
    Get-CalendarProcessing |
    Sort-Object -Property Identity |
    Format-Table -Property Identity, AllowConflicts -AutoSize |
    Out-String
  }
  Catch
  {
...
$disallowconflictmeetingsToolStripMenuItem_Click = {
  $ConflictMeetingDeny = Read-Host -Prompt 'Enter the Room Name of the Resource Calendar you want to disallow conflicts'
  try
  {
    ...
    $TextboxResults.Text = Get-CalendarProcessing -identity $ConflictMeetingDeny |
    Format-List -Property Identity, AllowConflicts |
    Out-String
  }
  catch
...
$enableAutomaticBookingForAllResourceMailboxToolStripMenuItem1_Click = {
  Try
  {
    ...
    Get-CalendarProcessing |
    Sort-Object -Property Identity |
    Format-Table -Property Identity, AutomateProcessing -AutoSize |
    Out-String
  }
  Catch
  {
...
$GetRoomMailBoxCalendarProcessingToolStripMenuItem_Click = {
  $RoomMailboxCalProcessing = Read-Host -Prompt 'Enter the Calendar Name you want to view calendar processing information for'
  try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $RoomMailboxCalProcessing |
    Get-CalendarProcessing |
    Format-List |
    Out-String
  }
...
$convertAMailboxToARoomMailboxToolStripMenuItem_Click = {
  $MailboxtoRoom = Read-Host -Prompt 'What user would you like to convert to a Room Mailbox? Please enter the full email address'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailBox $MailboxtoRoom |
    Format-List -Property Name, ResourceType, PrimarySmtpAddress, EmailAddresses, UserPrincipalName, IsMailboxEnabled |
    Out-String
  }
  Catch
  {
...
$createANewRoomMailboxToolStripMenuItem_Click = {
  $NewRoomMailbox = Read-Host -Prompt 'Enter the name of the new room mailbox'
  Try
  {
    $TextboxResults.Text = "Creating the $NewRoomMailbox Room Mailbox..."
    $textboxDetails.Text = "New-Mailbox -Name $NewRoomMailbox -Room "
    $TextboxResults.Text = New-Mailbox -Name $NewRoomMailbox -Room |
    Format-List |
    Out-String
  }
  Catch
...
$removeARoomMailboxToolStripMenuItem_Click = {
  $RemoveRoomMailbox = Read-Host -Prompt 'Enter the name of the room mailbox'
  Try
  {
...
$blacklistDomainForAllToolStripMenuItem_Click = {
  $BlacklistDomain = Read-Host -Prompt 'Enter the domain you want to blacklist for all users. EX: google.com'
  try
  {
    ...
    Get-Mailbox | Set-MailboxJunkEmailConfiguration -BlockedSendersAndDomains @{
      Add = $BlacklistDomain
    } 
    $TextboxResults.Text = Get-Mailbox |
    Get-MailboxJunkEmailConfiguration |
    Sort-Object -Property Identity |
    Format-Table -Property Identity, BlockedSendersAndDomains, Enabled -AutoSize |
    Out-String
  }
  catch
  {
...
$blacklistDomainForASingleUserToolStripMenuItem_Click = {
  $Blockeddomainuser = Read-Host -Prompt 'Enter the UPN of the user you want to modify junk email for'
  $BlockedDomain2 = Read-Host -Prompt 'Enter the domain you want to blacklist'
  try
  {
    ...
    Set-MailboxJunkEmailConfiguration -Identity $Blockeddomainuser -BlockedSendersAndDomains @{
      Add = $BlockedDomain2
    } 
    $TextboxResults.Text = Get-MailboxJunkEmailConfiguration -Identity $Blockeddomainuser |
    Format-List -Property Identity, BlockedSendersAndDomains |
    Out-String
  }
  catch
  {
...
$blacklistASpecificEmailAddressForAllToolStripMenuItem_Click = {
  $BlockSpecificEmailForAll = Read-Host -Prompt 'Enter the email address you want to blacklist for all'
  try
  {
...
$blacklistASpecificEmailAddressForASingleUserToolStripMenuItem_Click = {
  $ModifyblacklistforaUser = Read-Host -Prompt 'Enter the user you want to modify the blacklist for'
  $DenySpecificEmailForOne = Read-Host -Prompt 'Enter the email address you want to whitelist for a single user'
  try
  {
    ...
    Set-MailboxJunkEmailConfiguration -Identity $ModifyblacklistforaUser -BlockedSendersAndDomains @{
      Add = $DenySpecificEmailForOne
    }
    $TextboxResults.Text = Get-MailboxJunkEmailConfiguration -Identity $ModifyblacklistforaUser |
    Format-List -Property Identity, BlockedSendersAndDomains, Enabled |
    Out-String
  }
  catch
  {
...
$checkSafeAndBlockedSendersForAUserToolStripMenuItem_Click = {
  $CheckSpamUser = Read-Host -Prompt 'Enter the UPN of the user you want to check blocked and allowed senders for'
  try
  {
    ...
    $TextboxResults.Text = Get-MailboxJunkEmailConfiguration -Identity $CheckSpamUser |
    Format-List -Property Identity, TrustedListsOnly, ContactsTrusted, TrustedSendersAndDomains, BlockedSendersAndDomains, TrustedRecipientsAndDomains, IsValid |
    Out-String
  }
  catch
  {
...
$whitelistDomainForAllToolStripMenuItem_Click = {
  $AllowedDomain = Read-Host -Prompt 'Enter the domain you want to whitelist for all users. EX: google.com'
  try
  {
    ...
    Get-Mailbox | Set-MailboxJunkEmailConfiguration -TrustedSendersAndDomains @{
      Add = $AllowedDomain
    }
    $TextboxResults.Text = Get-Mailbox |
    Get-MailboxJunkEmailConfiguration |
    Sort-Object -Property Identity |
    Format-Table -Property Identity, TrustedSendersAndDomains, TrustedRecipientsAndDomains -AutoSize |
    Out-String
  }
  catch
  {
...
$whitelistDomainForASingleUserToolStripMenuItem_Click = {
  $Alloweddomainuser = Read-Host -Prompt 'Enter the UPN of the user you want to modify junk email for'
  $AllowedDomain2 = Read-Host -Prompt 'Enter the domain you want to whitelist'
  try
  {
    ...
    Set-MailboxJunkEmailConfiguration -Identity $Alloweddomainuser -TrustedSendersAndDomains @{
      Add = $AllowedDomain2
    }
    $TextboxResults.Text = Get-MailboxJunkEmailConfiguration -Identity $Alloweddomainuser |
    Format-List -Property Identity, TrustedSendersAndDomains, TrustedRecipientsAndDomains |
    Out-String
  }
  catch
  {
...
$whitelistASpecificEmailAddressForAllToolStripMenuItem_Click = {
  $AllowSpecificEmailForAll = Read-Host -Prompt 'Enter the email address you want to whitelist for all'
  try
  {
    ...
    Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Set-MailboxJunkEmailConfiguration -TrustedSendersAndDomains @{
      Add = $AllowSpecificEmailForAll
    }
    $TextboxResults.Text = Get-Mailbox |
    Where-Object -FilterScript { $_.RecipientType -eq 'UserMailbox' } |
    Get-MailboxJunkEmailConfiguration |
...
$whitelistASpecificEmailAddressForASingleUserToolStripMenuItem_Click = {
  $ModifyWhitelistforaUser = Read-Host -Prompt 'Enter the user you want to modify the whitelist for'
  $AllowSpecificEmailForOne = Read-Host -Prompt 'Enter the email address you want to whitelist for a single user'
  try
  {
    ...
    Set-MailboxJunkEmailConfiguration -Identity $ModifyWhitelistforaUser -TrustedSendersAndDomains @{
      Add = $AllowSpecificEmailForOne
    }
    $TextboxResults.Text = Get-MailboxJunkEmailConfiguration -Identity $ModifyWhitelistforaUser |
    Format-List -Property Identity, TrustedSendersAndDomains, TrustedRecipientsAndDomains, Enabled |
    Out-String
  }
  catch
  {
...
$addContactsPermissionsForAUserToolStripMenuItem_Click = {
  $ContacsUser = Read-Host -Prompt 'Enter the UPN of the user whose contacts folder you want to give access to'
  $Contactsuser2 = Read-Host -Prompt 'Enter the UPN of the user who you want to give access to'
  ...
  try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${ContacsUser}:\contacts |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, FolderName -AutoSize |
    Out-String
  }
  Catch
  {
...
$getUsersContactsPermissionsToolStripMenuItem_Click = {
  $ContactsUserPermissions = Read-Host -Prompt 'What user would you like contacts folder permissions for?'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${ContactsUserPermissions}:\contacts |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, FolderName -AutoSize |
    Out-String
  }
...
$removeAUserFromSomeonesContactsPermissionsToolStripMenuItem_Click = {
  $Contactsuserremove = Read-Host -Prompt 'Enter the UPN of the user whose contacts you want to remove access to'
  $Contactsuser2remove = Read-Host -Prompt 'Enter the UPN of the user who you want to remove access'
  try
  {
    ...
    $TextboxResults.Text = Get-MailboxFolderPermission -Identity ${Contactsuserremove}:\contacts |
    Sort-Object -Property User, AccessRights |
    Format-Table -Property User, AccessRights, FolderName -AutoSize |
    Out-String
  }
...
$removeAUserFromAllContactsFoldersToolStripMenuItem_Click = {
  $RemoveUserFromAllContacts = Read-Host -Prompt 'Enter the UPN of the user you want to remove from all contacts folders'
  try
  {
...
$addASingleUserPermissionsOnAllContactsFoldersToolStripMenuItem_Click = {
  $MasterUserContacts = Read-Host -Prompt 'Enter the UPN of the user you want permission on all users contacts folders'
  $TextboxResults.text = 'Contacts Permissions: 
    Owner
    PublishingEditor
    Editor
...
$disableAccessToOWAForASingleUserToolStripMenuItem_Click = {
  $DisableOWAforUser = Read-Host -Prompt 'Enter the UPN of the user you want to disable OWA access for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox $DisableOWAforUser |
    Format-List -Property DisplayName, OWAEnabled |
    Out-String
  }
  catch
  {
...
$enableOWAAccessForASingleUserToolStripMenuItem_Click = {
  $EnableOWAforUser = Read-Host -Prompt 'Enter the UPN of the user you want to enable OWA access for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox $EnableOWAforUser |
    Format-List -Property DisplayName, OWAEnabled |
    Out-String
  }
  catch
...
$disableOWAAccessForAllToolStripMenuItem_Click = {
  try
  {
    ...
    Get-CASMailbox |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, OWAEnabled -AutoSize |
    Out-String
  }
  catch
  {
...
$getOWAAccessForAllToolStripMenuItem_Click = {
  try
  {
    ...
    Get-CASMailbox |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, OWAEnabled, OwaMailboxPolicy, OWAforDevicesEnabled -AutoSize |
    Out-String
  }
  catch
  {
...
$getOWAInfoForASingleUserToolStripMenuItem_Click = {
  $OWAAccessUser = Read-Host -Prompt 'Enter the UPN for the User you want to view OWA info for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox -identity $OWAAccessUser |
    Format-List -Property DisplayName, OWAEnabled, OwaMailboxPolicy, OWAforDevicesEnabled |
    Out-String
  }
  catch
  {
...
$getActiveSyncDevicesForAUserToolStripMenuItem_Click = {
  $ActiveSyncDevicesUser = Read-Host -Prompt 'Enter the UPN of the user you wish to see ActiveSync Devices for'
  try
  {
    ...
    $TextboxResults.Text = Get-MobileDeviceStatistics -Mailbox $ActiveSyncDevicesUser |
    Format-List -Property DeviceFriendlyName, DeviceModel, DeviceOS, DeviceMobileOperator, DeviceType, Status, FirstSyncTime, LastPolicyUpdateTime, LastSyncAttemptTime, LastSuccessSync, LastPingHeartbeat, DeviceAccessState, IsValid  |
    Out-String
  }
  catch
  {
...
$disableActiveSyncForAUserToolStripMenuItem_Click = {
  $DisableActiveSyncForUser = Read-Host -Prompt 'Enter the UPN of the user you wish to disable ActiveSync for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox -Identity $DisableActiveSyncForUser |
    Format-List -Property DisplayName, ActiveSyncEnabled |
    Out-String
  }
  catch
  {
...
$enableActiveSyncForAUserToolStripMenuItem_Click = {
  $EnableActiveSyncForUser = Read-Host -Prompt 'Enter the UPN of the user you wish to enable ActiveSync for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox -Identity $EnableActiveSyncForUser |
    Format-List -Property DisplayName, ActiveSyncEnabled |
    Out-String
  }
  catch
...
$viewActiveSyncInfoForAUserToolStripMenuItem_Click = {
  $ActiveSyncInfoForUser = Read-Host -Prompt 'Enter the UPN for the user you want to view ActiveSync info for'
  try
  {
    ...
    $TextboxResults.Text = Get-CASMailbox -Identity $ActiveSyncInfoForUser |
    Format-List -Property DisplayName, ActiveSyncEnabled, ActiveSyncAllowedDeviceIDs, ActiveSyncBlockedDeviceIDs, ActiveSyncMailboxPolicy, ActiveSyncMailboxPolicyIsDefaulted, ActiveSyncDebugLogging, HasActiveSyncDevicePartnership |
    Out-String
  }
  catch
  {
...
$disableActiveSyncForAllToolStripMenuItem_Click = {
  try
  {
    ...
    Get-CASMailbox  |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, ActiveSyncEnabled -AutoSize |
    Out-String
  }
  catch
  {
...
$disableAccessToPowerShellForAUserToolStripMenuItem_Click = {
  $DisablePowerShellforUser = Read-Host -Prompt 'Enter the UPN of the user you want to disable PowerShell access for'
  try
  {
    ...
    $TextboxResults.Text = Get-User $DisablePowerShellforUser |
    Format-List -Property DisplayName, RemotePowerShellEnabled |
    Out-String
  }
  catch
  {
...
$displayPowerShellRemotingStatusForAUserToolStripMenuItem_Click = {
  $PowerShellRemotingStatusUser = Read-Host -Prompt 'Enter the UPN of the user you want to view PowerShell Remoting for'
  try
  {
    ...
    $TextboxResults.Text = Get-User $PowerShellRemotingStatusUser |
    Format-List -Property DisplayName, RemotePowerShellEnabled |
    Out-String
  }
  catch
...
$enableAccessToPowerShellForAUserToolStripMenuItem_Click = {
  $EnablePowerShellforUser = Read-Host -Prompt 'Enter the UPN of the user you want to enable PowerShell access for'
  try
  {
    ...
    $TextboxResults.Text = Get-User $EnablePowerShellforUser |
    Format-List -Property DisplayName, RemotePowerShellEnabled |
    Out-String
  }
  catch
...
$getPowerShellRemotingStatusForAllToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-User |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, RemotePowerShellEnabled -AutoSize |
    Out-String
  }
  catch
  {
...
$GetAllRecentToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-MessageTrace |
    Format-List -Property Received, SenderAddress, RecipientAddress, FromIP, ToIP, Subject, Size, Status |
    Out-String
  }
  catch
  {
...
$fromACertainSenderToolStripMenuItem1_Click = {
  $MessageTraceSender = Read-Host -Prompt 'Enter the senders email address'
  try
  {
    ...
    $TextboxResults.Text = Get-MessageTrace -SenderAddress $MessageTraceSender |
    Format-List -Property Received, SenderAddress, RecipientAddress, FromIP, ToIP, Subject, Size, Status |
    Out-String
  }
  catch
...
$toACertainRecipientToolStripMenuItem_Click = {
  $MessageTraceRecipient = Read-Host -Prompt 'Enter the recipients email address'
  try
  {
    ...
    $TextboxResults.Text = Get-MessageTrace -RecipientAddress $MessageTraceRecipient |
    Format-List -Property Received, SenderAddress, RecipientAddress, FromIP, ToIP, Subject, Size, Status |
    Out-String
  }
  catch
...
$getFailedMessagesToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-MessageTrace -Status 'Failed' |
    Format-List -Property Received, SenderAddress, RecipientAddress, FromIP, ToIP, Subject, Size, Status |
    Out-String
  }
  catch
...
$GetMessagesBetweenDatesToolStripMenuItem_Click = {
  $MessageTraceStartDate = Read-Host -Prompt 'Enter the start date. EX: 06/13/2015 or 09/01/2015 5:00 PM'
  $MessageTraceEndDate = Read-Host -Prompt 'Enter the end date. EX: 06/15/2015 or 09/01/2015 5:00 PM'
  try
  {
    ...
    $TextboxResults.Text = Get-MessageTrace -StartDate $MessageTraceStartDate -EndDate $MessageTraceEndDate |
    Format-List -Property Received, SenderAddress, RecipientAddress, FromIP, ToIP, Subject, Size, Status |
    Out-String
  }
  catch
...
$getTechnicalNotificationEmailToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolCompanyInformation |
    Format-List -Property TechnicalNotificationEmails |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolCompanyInformation -TenantId $PartnerComboBox.SelectedItem.TenantID |
    Format-List -Property TechnicalNotificationEmails |
    Out-String
  }
  Else
...
$lastDirSyncTimeToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolCompanyInformation |
    Format-List -Property LastDirSyncTime |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$getLastPasswordSyncTimeToolStripMenuItem_Click = {
  ...
  If (Get-PSSession -Name mainaccount -ErrorAction SilentlyContinue)
  {
    ...
    $TextboxResults.Text = Get-MsolCompanyInformation |
    Format-List -Property LastPasswordSyncTime |
    Out-String
  }
  #What to do if connected to partner account
  ElseIf (Get-PSSession -Name partneraccount -ErrorAction SilentlyContinue)
...
$getSharingPolicyToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-SharingPolicy |
    Format-List -Property Name, Domains, Enabled, Default, Identity, WhenChanged, WhenCreated, IsValid, ObjectState |
    Out-String
  }
  catch
  {
...
$disableASharingPolicyToolStripMenuItem_Click = {
  $DisableSharingPolicy = Read-Host -Prompt 'Enter the name of the policy you want to disable'
  try
  {
    ...
    $TextboxResults.Text = Get-SharingPolicy -Identity $DisableSharingPolicy |
    Format-List -Property Name, Enabled, ObjectState |
    Out-String
  }
  catch
  {
...
$enableASharingPolicyToolStripMenuItem_Click = {
  $EnableSharingPolicy = Read-Host -Prompt 'Enter the name of the policy you want to Enable'
  try
  {
    ...
    $TextboxResults.Text = Get-SharingPolicy -Identity $EnableSharingPolicy |
    Format-List -Property Name, Enabled, ObjectState |
    Out-String
  }
  catch
...
$createANewSharingPolicyToolStripMenuItem_Click = {
  ...
  $TextboxResults.Text = Get-OrganizationConfig |
  Format-List  -Property Identity, IsDehydrated |
  Out-String
  $NewSharingPolicyName = Read-Host -Prompt 'Enter the name for the sharing policy'
  ...
  $SharingPolicy = Read-Host -Prompt 'Enter the domain this policy will apply to and the value'
  try
  {
    ...
    $TextboxResults.Text = Get-SharingPolicy -Identity $NewSharingPolicyName |
    Format-List -Property Name, Domains, Enabled, Default, Identity, WhenChanged, WhenCreated, IsValid, ObjectState |
    Out-String
  }
  catch
...
$getInfoForASingleSharingPolicyToolStripMenuItem_Click = {
  $DetailedInfoForSharingPolicy = Read-Host -Prompt 'Enter the name of the policy you want info for'
  try
  {
    ...
    $TextboxResults.Text = Get-SharingPolicy -Identity $DetailedInfoForSharingPolicy |
    Format-List -Property Name, Domains, Enabled, Default, Identity, WhenChanged, WhenCreated, IsValid, ObjectState |
    Out-String
  }
  catch
...
$getCustomizationStatusToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-OrganizationConfig |
    Format-Table  -Property Identity, IsDehydrated -AutoSize |
    Out-String
  }
  catch
  {
...
$getSharepointSiteToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-OrganizationConfig |
    Format-List -Property SharePointUrl |
    Out-String
  }
  Catch
  {
...
$getAllMailboxSizesToolStripMenuItem_Click = {
  try
  {
    ...
    ItemCount |
    Sort-Object -Property 'TotalItemSize (MB)' -Descending |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$getMailMalwareReportToolStripMenuItem1_Click = {
  ...
  Try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport |
    Format-List |
    Out-String
  }
  Catch
...
$getMailMalwareReportFromSenderToolStripMenuItem_Click = {
  $MalwareSender = Read-Host -Prompt 'Enter the email of the sender'
  try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport -SenderAddress $MalwareSender |
    Format-List |
    Out-String
  }
  Catch
...
$getMailMalwareReportBetweenDatesToolStripMenuItem_Click = {
  $MalwareReportStart = Read-Host -Prompt 'Enter the start date. EX: 06/13/2015'
  $MalwareReportEnd = Read-Host -Prompt 'Enter the end date. EX: 06/15/2015 '
  try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport -StartDate $MalwareReportStart -EndDate $MalwareReportEnd |
    Format-List |
    Out-String
  }
  Catch
...
$getMailMalwareReportToARecipientToolStripMenuItem_Click = {
  $MalwareRecipient = Read-Host -Prompt 'Enter the email of the recipient'
  try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport -RecipientAddress $MalwareRecipient |
    Format-List |
    Out-String
  }
  Catch
...
$getMailMalwareReporforInboundToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport -Direction Inbound |
    Format-List |
    Out-String
  }
  Catch
...
$getMailMalwareReportForOutboundToolStripMenuItem_Click = {
  try
  {
    ...
    $TextboxResults.Text = Get-MailDetailMalwareReport -Direction Outbound |
    Format-List |
    Out-String
  }
  Catch
...
$getRecentMailTrafficReportToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailTrafficReport |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$getInboundMailTrafficReportToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailTrafficReport -Direction Inbound |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$getOutboundMailTrafficReportToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailTrafficReport -Direction Outbound |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$getMailTrafficReportBetweenDatesToolStripMenuItem_Click = {
  $MailTrafficStart = Read-Host -Prompt 'Enter the start date. EX: 06/13/2015'
  $MailTrafficEnd = Read-Host -Prompt 'Enter the end date. EX: 06/15/2015 '
  Try
  {
    ...
    $TextboxResults.Text = Get-MailTrafficReport -StartDate $MailTrafficStart -EndDate $MailTrafficEnd |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$createASharedMailboxToolStripMenuItem_Click = {
  $NewSharedMailbox = Read-Host -Prompt 'Enter the name of the new Shared Mailbox'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox -RecipientTypeDetails SharedMailbox |
    Format-Table -AutoSize |
    Out-String
  }
  Catch
...
$convertRegularMailboxToSharedToolStripMenuItem_Click = {
  $ConvertMailboxtoShared = Read-Host -Prompt 'Enter the name of the account you want to convert'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox -Identity $ConvertMailboxtoShared |
    Format-List -Property UserPrincipalName, DisplayName, RecipientTypeDetails, PrimarySmtpAddress, EmailAddresses, IsDirSynced |
    Out-String
  }
  Catch
  {
...
$convertSharedMailboxToRegularToolStripMenuItem_Click = {
  $ConvertMailboxtoRegular = Read-Host -Prompt 'Enter the name of the account you want to convert'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox -Identity $ConvertMailboxtoRegular |
    Format-List -Property UserPrincipalName, DisplayName, RecipientTypeDetails, PrimarySmtpAddress, EmailAddresses, IsDirSynced |
    Out-String
  }
  Catch
...
$getDetailedInfoForASharedMailboxToolStripMenuItem_Click = {
  $SharedMailboxDetailedInfo = Read-Host -Prompt 'Enter the name of the shared mailbox'
  Try
  {
    ...
    $TextboxResults.Text = Get-Mailbox $SharedMailboxDetailedInfo |
    Format-List |
    Out-String
  }
  Catch
...
$exportAllUsersMailboxPermissionsToCSVToolStripMenuItem_Click = {
  Try
  {
    $OutputFile = Read-Host -Prompt 'Enter the location and name for the CSV. EX: C:\Scripts\UserPerms.csv'
    ...
    Function Main
    {
      ...
      $objUsers = get-mailbox -ResultSize Unlimited | Select-Object -Property UserPrincipalName
      ...
      Foreach ($objUser in $objUsers)
      {
        ...
        $objUserMailbox = get-mailboxpermission -Identity $($objUser.UserPrincipalName) | Select-Object -Property User, AccessRights, Deny, IsInherited
...
$addFullAccessPermissionsToASharedMailboxToolStripMenuItem_Click = {
  $SharedMailboxFullAccess = Read-Host -Prompt 'Enter the name of the shared mailbox'
  $GrantFullAccesstoSharedMailbox = Read-Host -Prompt 'Enter the UPN of the user that will have full access'
  Try
  {
    ...
    $TextboxResults.Text = Add-MailboxPermission $SharedMailboxFullAccess -User $GrantFullAccesstoSharedMailbox -AccessRights FullAccess -InheritanceType All |
    Format-List |
    Out-String
  }
  Catch
...
$getSharedMailboxPermissionsToolStripMenuItem_Click = {
  $SharedMailboxPermissionsList = Read-Host -Prompt 'Enter the name of the Shared Mailbox'
  Try
  {
    ...
    $TextboxResults.Text = Get-RecipientPermission $SharedMailboxPermissionsList |
    Where-Object -FilterScript { ($_.Trustee -notlike 'NT AUTHORITY\SELF') } |
    Sort-Object -Property Trustee |
    Format-Table -Property Trustee, AccessControlType, AccessRights -AutoSize|
    Out-String
  }
  Catch
  {
...
$getSharedMailboxFullAccessPermissionsToolStripMenuItem_Click = {
  $SharedMailboxFullAccessPermissionsList = Read-Host -Prompt 'Enter the name of the Shared Mailbox'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailboxPermission $SharedMailboxFullAccessPermissionsList |
    Where-Object -FilterScript { ($_.User -notlike 'NT AUTHORITY\SELF') } |
    Sort-Object -Property Identity |
    Format-Table -Property Identity, User, AccessRights -AutoSize |
    Out-String
  }
  Catch
  {
...
$addSendAsAccessToASharedMailboxToolStripMenuItem_Click = {
  $SharedMailboxSendAsAccess = Read-Host -Prompt 'Enter the name of the shared mailbox'
  $SharedMailboxSendAsUser = Read-Host -Prompt 'Enter the UPN of the user'
  Try
  {
    ...
    $TextboxResults.Text = Add-RecipientPermission $SharedMailboxSendAsAccess -Trustee $SharedMailboxSendAsUser -AccessRights SendAs |
    Format-List |
    Out-String
  }
  Catch
...
$createANewMailContactToolStripMenuItem_Click = {
  $ContactFirstName = Read-Host -Prompt 'Enter the contacts first name'
  $ContactsLastName = Read-Host -Prompt 'Enter the contacts last name'
  $ContactName = $ContactFirstName + ' ' + $ContactsLastName
  $ContactExternalEmail = Read-Host -Prompt "Enter external email for $ContactName"
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact -Identity $ContactName |
    Format-List -Property DisplayName, EmailAddresses, PrimarySmtpAddress, ExternalEmailAddress, RecipientType |
    Out-String
  }
  Catch
  {
...
$getAllContactsToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, EmailAddresses -AutoSize |
    Out-String
  }
  Catch
  {
...
$getDetailedInfoForAContactToolStripMenuItem_Click = {
  $DetailedInfoForContact = Read-Host -Prompt 'Enter the contact name, displayname, alias or email address'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact -Identity $DetailedInfoForContact |
    Format-List |
    Out-String
  }
  Catch
...
$removeAContactToolStripMenuItem_Click = {
  $RemoveMailContact = Read-Host -Prompt 'Enter the contact name, displayname, alias or email address'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, EmailAddresses, PrimarySmtpAddress, ExternalEmailAddress, RecipientType -AutoSize |
    Out-String
  }
  Catch
  {
...
$hideContactFromGALToolStripMenuItem_Click = {
  $HideGALMailContact = Read-Host -Prompt 'Enter the contact name, displayname, alias or email address'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact -Identity $HideGALMailContact |
    Format-List -Property DisplayName, HiddenFromAddressListsEnabled |
    Out-String
  }
  Catch
  {
...
$unhideContactFromGALToolStripMenuItem_Click = {
  $unHideGALMailContact = Read-Host -Prompt 'Enter the contact name, displayname, alias or email address'
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact -Identity $unHideGALMailContact |
    Format-List -Property DisplayName, HiddenFromAddressListsEnabled |
    Out-String
  }
  Catch
...
$getGALStatusForAllUsersToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, HiddenFromAddressListsEnabled -AutoSize |
    Out-String
  }
  Catch
  {
...
$getContactsHiddenFromGALToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact |
    Where-Object -FilterScript { $_.HiddenFromAddressListsEnabled -like 'True' } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, HiddenFromAddressListsEnabled -AutoSize |
    Out-String
  }
...
$getContactsNotHiddenFromGALToolStripMenuItem_Click = {
  Try
  {
    ...
    $TextboxResults.Text = Get-MailContact |
    Where-Object -FilterScript { $_.HiddenFromAddressListsEnabled -like 'False' } |
    Sort-Object -Property DisplayName |
    Format-Table -Property DisplayName, HiddenFromAddressListsEnabled -AutoSize |
    Out-String
  }
...
$menustrip1_ItemClicked = [System.Windows.Forms.ToolStripItemClickedEventHandler]{#Event Argument: $_ = [System.Windows.Forms.ToolStripItemClickedEventArgs]
}
