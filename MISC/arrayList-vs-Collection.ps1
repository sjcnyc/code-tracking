...
(1..10).ForEach{ Measure-Command -Expression {
  ...
  } } | ForEach-Object { $t = 0 ; $c = 0 } { ++$c ; $t += $_.TotalMilliseconds } { [pscustomobject] @{ Name = "ArrayList"; Time = $t / $c } }

# Generic list - typed, holds a string in this case
(1..10).ForEach{ Measure-Command -Expression {
    $List = New-Object System.Collections.Generic.List[string]
    (1..10000).Foreach{ $List.Add("Foo Bar") }
  } } | ForEach-Object { $t = 0 ; $c = 0 } { ++$c ; $t += $_.TotalMilliseconds } { [pscustomobject] @{ Name = "List" ; Time = $t / $c } }

# Pipeline
(1..10).ForEach{ Measure-Command {
    ($List = 1..10000).ForEach{ "Foo Bar" }
  } } | ForEach-Object { $t = 0 ; $c = 0 } { ++$c ; $t += $_.TotalMilliseconds } { [pscustomobject] @{ Name = "Pipeline"; Time = $t / $c } }
