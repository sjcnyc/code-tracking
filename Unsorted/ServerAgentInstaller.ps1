...
$splunkSub = New-SimpleMenu -Title "Choose Splunk Region" -TitleForegroundColor Cyan -Items @(
    "SME - Germany" | New-SimpleMenuItem -Action {Write-Host "Germany"}
    "SME - HK"      | New-SimpleMenuItem -Action {Write-Host "HK"}
    "SME - GDCW"    | New-SimpleMenuItem -Action {Write-Host " GDCW"}
    "Back"          | New-SimpleMenuItem -Quit -Key 'b'
)

$menu1 = New-SimpleMenu -Title "Sony Music Agent Installer" -TitleForegroundColor Cyan -Items @(
    "Auto Install"   | New-SimpleMenuItem -Action {Write-Host "Auto Install"}
    "Install Splunk" | New-SimpleMenuItem -Submenu $splunkSub
    "McAfee VSE"     | New-SimpleMenuItem -Action {Write-Host "McAfee VSE"}
    "McAfee Agent"   | New-SimpleMenuItem -Action {Write-Host "McAfee Agent"}
    "Qualys"         | New-SimpleMenuItem -Action {Write-Host "Qualys"}
    "FireEye"        | New-SimpleMenuItem -Action {Write-Host "FireEye"}
    "Quit"           | New-SimpleMenuItem -ForegroundColor Magenta -Key 'x' -Quit
)

Invoke-SimpleMenu $menu1